...
void test_searcher() {
    ...
    "searcher"_test = []() {
        ...
        std::println("nodes = {}, time = {} ms, nps = {}", nodes, dt, size_t(nodes / (dt / 1000.0)));
    };
}
